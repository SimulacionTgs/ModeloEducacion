...
class Simulacion
{
  ...
  public function getADefaults() {
    ...
    $aDefaults["iEstatusSocioEcon"] = rand(1,6);
    $aDefaults["iHabilidades"] = 3;
    $aDefaults["iActiviDiarias"] = 4;
    $aDefaults["iCantDiscap"] = 60;
    $aDefaults["iCantGraduados"] = 25;
    $aDefaults["iCantPersonal"] = 10;
    $aDefaults["iExperiencia"] = 3;
    $aDefaults["sUniversidad"] = 'media';
    $aDefaults["sCarrera"] = 'media';
    $aDefaults["sTipoInstitucion"] = 'semipublico';
